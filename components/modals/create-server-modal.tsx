                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8"> 
                                ...
                                render={({ field })=>(
                                    <FormItem>
                                        ...
                                        <FormControl> 
                                            <Input 
                                                disabled={isLoading}
                                                className="bg-white dark:border-0 border-black focus-visible: ring-0 text-black focus-visible:ring-offset-0"
                        ...
                        <DialogFooter className="items-center">
                                <Button className="bg-center flex flex-col items-center" variant="primary" disabled={isLoading}>
                                    Create
                                </Button>
                        </DialogFooter>         
                    </form>
