...
import { Check, Gavel, MoreVertical, Shield, ShieldAlert, ShieldCheck, ShieldQuestion, Loader2 } from "lucide-react";
...
export const MembersModal = () => {
    ...
    return (
        <Dialog open={isModalOpen} onOpenChange={onClose}>
            <DialogContent className="bg-white dark:bg-zinc-700 text-black overflow-hidden" > 
                        ...
                        <div key={member.id} className="flex items-center gap-x-2 mb-6" > 
                            <UserAvatar src={member.profile.imageUrl} />
                                <div className="flex flex-col gay-y-1">
                                    <div className="flex-xs font-semibold flex items-center gap-x-1 dark:text-zinc-50">
                                        {member.profile.name}
                                ...
                                {server.profileId !== member.profileId && loadingId !== member.id && (
                                    <div className="ml-auto"> 
                                       <DropdownMenu> 
                                        <DropdownMenuTrigger>
                                            <MoreVertical className="h-4 w-4 text-zinc-500 dark:text-white"/>
                                        </DropdownMenuTrigger>
